...
export const getTraineeAttendanceCols = () => {
  let cols = ["S.No", "Trainee Name", "Department"];
  for (let i = 1; i <= 31; i++) {
    cols.push(`${i} In`);
    cols.push(`${i} Out`);
  }
...
export const TraineeAttendanceRegister = ({
  rows,
  setRows,
  month,
  selectedReg,
  ...
  const handleDownload = () => {
    ...
    downloadExcelFile(dataToExport, "Trainee_Attendance", branch, month);
  };

  const currentCols = getTraineeAttendanceCols();
        ...
        >
          ...
          >
            <tr>
              ...
              {currentCols.map((col) => {
                const isSticky = col === "S.No" || col === "Trainee Name" || col === "Department";
                let leftPos = 0;
                if (col === "S.No") leftPos = 40;
                if (col === "Trainee Name") leftPos = 80;
                if (col === "Department") leftPos = 300;
                ...
                return (
                  <th
                    ...
                    style={{
                      ...
                      minWidth:
                        col === "S.No" ? "40px" : 
                        col === "Trainee Name" ? "220px" : 
                        col === "Department" ? "180px" : "65px",
            ...
            {rows.map((row, index) => (
              <tr key={row.id}>
                ...
                {currentCols.map((col) => {
                  ...
                  const isSticky = isSNo || col === "Trainee Name" || col === "Department";
                    ...
                    >
                      <input
                        ...
                        style={{
                          ...
                          backgroundColor:
                            isH ? "#fef3c7" : 
                            row[col]?.toUpperCase() === "L" ? "#fee2e2" : 
                            isSNo ? "#f8fafc" : "transparent",
                          color: isH ? "#92400e" : row[col]?.toUpperCase() === "L" ? "#b91c1c" : "#1e293b",
                          fontWeight: isH || row[col]?.toUpperCase() === "L" || isSNo ? "bold" : "normal",
                        }}
                      />
                    </td>
                  );
